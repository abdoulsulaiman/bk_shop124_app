...
public class DrinkController {
	...
	public ResponseEntity<Object> getDrinkByUuid(HttpServletRequest request, @PathVariable("uuid") String uuid) {
	...
	@RequestMapping(method = RequestMethod.DELETE,value = "/delete/{uuid}",consumes=MediaType.APPLICATION_JSON_VALUE)
	 public  ResponseEntity<Object> deleteDrink(HttpServletRequest request, @PathVariable String uuid){
	...
	public ResponseEntity<Object> RegisterRequest(@RequestBody InnerDrinkData params, HttpSession session) throws ParseException {
	...
	public ResponseEntity<Object> getMostConsumedDrink(HttpServletRequest request) {
	...
	public ResponseEntity<Object> getAllDrinkAndNearestCargo(HttpServletRequest request, @PathVariable("uuid") String uuid) {
